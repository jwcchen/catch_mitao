...
# 4.settings is used to store the parameters that does not change throughtout the game. In contrast, things in GameState are bond to change 
# miscellaneous:
# 5.state.active => is_running
# 6.music
# 7.shelve